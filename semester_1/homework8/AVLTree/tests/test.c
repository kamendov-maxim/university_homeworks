...
static const bool testCase(size_t testLen, UserInput const *const testCommands,
                           char *const *const keys, char *const *const values, char const *const *const charAnswers, bool const *const boolAnswers)
{
    Dictionary *dictionary = createDictionary();
    if (dictionary == NULL)
    {
...
const bool test(void)
{
    ...
    char const *const testKeys1[5] = {"five", "six", "six", "six", "five"};
    char const *const testValues1[2] = {"five", "six"};
    char const const *const charAnswers1[1] = {"five"};
    bool const boolAnswers1[] = {false};
    const bool testCase1 = testCase(5, testCommands1, testKeys1, testValues1, charAnswers1, boolAnswers1);

    UserInput testCommands2[5] = {checkKeyCommand, appendCommand, checkKeyCommand,
                                  deleteElementCommand, checkKeyCommand};
    char const *const testKeys2[5] = {"one", "one", "one", "one", "one"};
    char const *const testValues2[1] = {"one"};
    char const *charAnswers2[0] = {};
    bool const boolAnswers2[3] = {false, true, false};
    const bool testCase2 = testCase(5, testCommands2, testKeys2, testValues2, charAnswers2, boolAnswers2);
    ...
    char const *const testKeys3[7] = {"one", "one", "one", "one", "one", "one", "one"};
    char const *const testValues3[3] = {"one", "two", "one"};
    char const *charAnswers3[3] = {"one", "two", "one"};
    bool const boolAnswers3[0] = {};
    const bool testCase3 = testCase(4, testCommands3, testKeys3, testValues3, charAnswers3, boolAnswers3);
    ...
    char const *const testKeys4[7] = {"1", "2", "3", "4", "5", "6", "7"};
    char const *const testValues4[7] = {"1", "2", "3", "4", "5", "6", "7"};
    char const *charAnswers4[0] = {};
    bool const boolAnswers4[0] = {};
    const bool testCase4 = testCase(4, testCommands4, testKeys4, testValues4, charAnswers4, boolAnswers4);
